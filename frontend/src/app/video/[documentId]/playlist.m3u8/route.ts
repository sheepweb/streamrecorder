...
export async function GET(
  ...
  const s3Client = getS3(recording.createdAt);
  const bucket = getBucket(process.env.MEDIA_BUCKET!, recording.createdAt);
  ...
  const playlist = await combinePlaylistsWithSignedUrls(
    s3Client,
    bucket,
